...
#define INVERT_Z_DIR_DEFAULT false     // for Mendel set to false, for Orca set to true
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.245,80.245,1430,880}  // default steps per unit for Ultimaker
