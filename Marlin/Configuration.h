...
#define INVERT_E1_DIR_DEFAULT false    // for direct drive extruder v9 set to true, for geared extruder set to false
#define INVERT_E2_DIR_DEFAULT false   // for direct drive extruder v9 set to true, for geared extruder set to false
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   {80.245,80.245,11390,880}  // default steps per unit for Ultimaker
