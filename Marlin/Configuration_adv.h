...
// #define AUTOTEMP   //deactivated for printupys
#ifdef AUTOTEMP
...
#define X2_MAX_POS 0    // set maximum to the distance between toolheads when both heads are homed
