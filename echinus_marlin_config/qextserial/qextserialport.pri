...
qextserialport-library:!qextserialport-buildlib { 
    ...
    LIBS += -L$$QEXTSERIALPORT_LIBDIR \
        -l$$QEXTSERIALPORT_LIBNAME
    ...
    qextserialport-buildlib:contains(TEMPLATE, .*lib):contains(CONFIG, shared):DEFINES += QEXTSERIALPORT_BUILD_SHARED
